...
(function() {
    ...
    roomRate.textContent = '$' + hotel.roomRate.toFixed(2); // 방 가격 출력
    specialRate.textContent = hotel.offerPrice(); // 할인된 가격 출력
    ...
    function offerExpires(today) {
        ...
        // 페이지에 날짜를 출력하기 위해 날짜의 각 부분을 값을 가져온다
